...
<form action={{"/viewForAuction/itemedited/".$catalogueid."/".$item->id}} enctype="multipart/form-data" method="POST" class="w-25 row pt-4 ms-5 border-top border-light border-3">
