...
<form action="" method="GET" class="col-9">
  ...
  <div class="form-group ps-5">
    <input type="search" class="form-control" placeholder="Search by item name or artist name or category or price  or classification ....." name="search" value="{{$search}}" >
  </div>
  <button class="btn btn-primary ms-5 mt-3">Search</button>
  <a href="searchItemsModel">
...
<form action="" method="GET" class="col-9">
  ...
  <div class="form-group ps-5">
      <div class="row">
          <div class="col-3">
    <input type="search" class="form-control" placeholder="Search by item name ....." name="item_name" value="{{$search1}}" ></div>
    <div class="col-3">
    <input type="search" class="form-control" placeholder="Search by category name ....." name="category_name" value="{{$search2}}" ></div>
    </div>
  </div>
  <button class="btn btn-primary ms-5 mt-3">Search</button>
  <a href="searchItemsModel">
