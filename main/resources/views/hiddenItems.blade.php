...
<table class="table table-stripped">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
          <a href={{"/itemshow/".$item->catalogue_id."/".$item->id}}><i class="fas fa-eye"></i></a>
      </td>
    </tr>
    @endforeach
  </tbody>
</table>
<a href={{"/view/".$item->catalogue_id}}>View non-hidden ones.</a>
</div>
@else
<div class="d-flex bg-white h-100 ps-5">
   <p style="margin-top:250px; padding-top:7px; width:1400px; margin-bottom:500px; background-color:#fac3f7; padding-left:20px; padding-right:20px;">Looks like there are no anyhidden items.</p>
</div>
@endif
